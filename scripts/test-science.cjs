...
const tests = ['scaffold.test.ts', 'previewSession.test.ts', 'lesson-2/microscopy.test.ts', 'lesson-3/practical.test.ts', 'navigation.test.ts', 'lessons456.test.tsx', 'lessons789.test.tsx', 'teachingCopy.test.ts', 'variants.test.ts', 'examPreparation.test.ts', 'coach/coach.test.ts', 'revision-b/revision.test.ts']
