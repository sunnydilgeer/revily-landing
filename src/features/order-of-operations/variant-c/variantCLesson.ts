...
import { chooser } from '../../written-methods/model'
...
add(priority, 'Where should the brackets go to make 19?', 'N2.1 Q4b', expression('2+3\\times4-1=19', 'place-brackets'), choose(['(2 + 3) × 4 - 1 = 19', '2 + 3 × (4 - 1) = 19', '2 + (3 × 4) - 1 = 19']), working('(2 + 3) × 4 - 1 = 19', ['Group the addition so it happens first.', '2 + 3 = 5'], ['Multiply, then subtract.', '5 × 4 - 1 = 20 - 1 = 19']))
...
add(priority, 'Zain says “10 - 4 ÷ 2 = 3”. Show that Zain is wrong.', 'N2.1 Q5b', expression('10-4\\div2'), choose(['4 ÷ 2 = 2, then 10 - 2 = 8.', '10 - 4 = 6, then 6 ÷ 2 = 3.', '10 - 2 = 8, then 8 ÷ 4 = 2.']), working('10 - 4 ÷ 2 = 8, not 3', ['Divide before subtracting.', '4 ÷ 2 = 2'], ['Subtract the result from 10.', '10 - 2 = 8']), undefined, 'transfer')
add(priority, 'Priya says brackets always change the answer. Is she correct?', 'N2.1 Q5c', expression('2+3+4'), choose(['No. 2 + 3 + 4 and (2 + 3) + 4 both equal 9.', 'Yes. Any brackets force a different operation.', 'Yes. (2 + 3) + 4 equals 5 + 4, not 9.']), working('No - this bracket does not change the value.', ['Test a calculation with only addition.', '2 + 3 + 4 = 9'], ['Insert a bracket without changing the order.', '(2 + 3) + 4 = 5 + 4 = 9']), undefined, 'transfer')
...
add(fraction, 'Where should the denominator brackets go?', 'N2.2 Q4b', expression('\\frac{20}{2+3\\times2}', 'place-brackets'), choose(['20/((2 + 3) × 2)', '20/(2 + (3 × 2))', '(20/2) + 3 × 2']), working('20/((2 + 3) × 2) = 2', ['Group the addition in the denominator.', '2 + 3 = 5'], ['Multiply to finish the denominator.', '5 × 2 = 10'], ['Divide.', '20/10 = 2']))
...
add(fraction, 'Kofi says the fraction simplifies to 5. Show that he is wrong.', 'N2.2 Q5b', expression('\\frac{4+2\\times3}{2\\times5}'), choose(['The top and bottom are both 10, so the value is 1.', 'Add 4 + 2 first, so the top is 18 and the value is 1.8.', 'Cancel the two 2s, so the value is 7.']), working('1, not 5', ['Multiply before adding in the numerator.', '4 + 2 × 3 = 4 + 6 = 10'], ['Calculate the denominator.', '2 × 5 = 10'], ['Divide.', '10/10 = 1']), undefined, 'transfer')
add(fraction, 'Does the equivalent single-line calculation match the fraction?', 'N2.2 Q5c', expression('\\frac{3+3}{4-1}'), choose(['Yes - (3 + 3) ÷ (4 - 1) keeps both groups and also equals 2.', 'Yes - 3 + 3 ÷ 4 - 1 equals 2 without any brackets.', 'No - a fraction bar cannot be written as division.']), working('Yes - when the numerator and denominator stay grouped.', ['Work out the fraction.', '(3 + 3)/(4 - 1) = 6/3 = 2'], ['Rewrite the fraction bar as division and keep both groups.', '(3 + 3) ÷ (4 - 1) = 6 ÷ 3 = 2']), undefined, 'transfer')
...
add(algebraTopic, 'Why is 6x × 2x not the same as 6x + 2x?', 'N2.3 Q4b', expression('6x\\times2x\\quad\\text{and}\\quad6x+2x'), choose(['Multiplication gives 12x², but addition gives 8x.', 'Multiplication and addition both give 8x.', 'Multiplication gives 12x, but addition gives 8x².']), working('12x² is not the same as 8x.', ['Multiply coefficients and variable factors.', '6x × 2x = 12x²'], ['Add coefficients when the terms already match.', '6x + 2x = 8x']))
...
add(algebraTopic, 'Ravi says 3xy × 2x simplifies to 5x²y. Show that he is wrong.', 'N2.3 Q5b', expression('3xy\\times2x'), choose(['3 × 2 = 6 and x × x = x², so the answer is 6x²y.', '3 + 2 = 5 and x × x = x², so Ravi is correct.', '3 × 2 = 6 and x + x = 2x, so the answer is 12xy.']), working('6x²y, not 5x²y', ['Multiply the numerical coefficients.', '3 × 2 = 6'], ['Combine the variable factors.', 'xy × x = x²y'], ['Put the product together.', '3xy × 2x = 6x²y']), undefined, 'transfer')
add(algebraTopic, 'Sana says add or subtract before multiplying. Is she correct?', 'N2.3 Q5c', expression('2a\\times3a+a^2'), choose(['No - multiply first to get 6a², then add a² to get 7a².', 'Yes - add 3a + a² first, then multiply by 2a.', 'No - add the coefficients first to get 5a².']), working('No - 2a × 3a + a² = 7a².', ['Form the product first.', '2a × 3a = 6a²'], ['Now add the like term.', '6a² + a² = 7a²']), undefined, 'transfer')
