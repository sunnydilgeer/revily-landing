...
practice(prime, 'Write 20 as a product of its prime factors.', 'N7.1 Q2', select(['2² × 5', '2 × 10', '4 × 5'], 0), explain('20 = 2² × 5', '20 = 2 × 10 = 2 × 2 × 5.', 'All factors are prime, so group the two 2s as 2².'), 'A final answer must contain only prime factors.', methodWorking(factorTreeWorking(20)))
practice(prime, 'Express 150 as a product of its prime factors. Give your answer in index form.', 'N7.1 Q3', select(['2 × 3 × 5²', '2 × 75', '3 × 50'], 0), explain('150 = 2 × 3 × 5²', '150 splits to 2, 3, 5 and 5.', 'Group the repeated 5s as 5².'), 'Keep splitting the composite branches 75 and 25.', methodWorking(factorTreeWorking(150)))
practice(prime, 'Write 60 as a product of its prime factors.', 'N7.1 Q4a', select(['2² × 3 × 5', '2 × 30', '4 × 15'], 0), explain('60 = 2² × 3 × 5', 'The prime ends are 2, 2, 3 and 5.', 'Write the repeated 2s as 2².'), 'Use the factor tree from the video, but give the final answer in prime factors.', tree60)
...
practice(prime, 'Given 60 = 2² × 3 × 5, write 60² as a product of prime factors in index form.', 'N7.1 Q4b', select(['2⁴ × 3² × 5²', '2² × 3 × 5', '2⁴ × 3 × 5'], 0), explain('60² = 2⁴ × 3² × 5²', 'Start with 60 = 2² × 3 × 5.', 'Squaring doubles every exponent.'), 'Apply the outside square to every prime factor.', methodWorking(square60), ['60 = 2² × 3 × 5', 'Square the complete product'])
practice(prime, 'Write 96 as a product of its prime factors. Give your answer in index form.', 'N7.1 Q5a', select(['2⁵ × 3', '2⁴ × 6', '2 × 48'], 0), explain('96 = 2⁵ × 3', 'Repeatedly split off 2: five copies of 2 remain with 3.', 'Group the five 2s as 2⁵.'), 'Continue until the remaining branch is prime.', methodWorking(factorTreeWorking(96)))
practice(prime, 'A student says 96 is a square number because its prime factorisation contains the even prime 2. Is the student correct?', 'N7.1 Q5b (contradictory exponent wording repaired)', select([
...
], 0), explain('No - 96 is not a square number.', 'A square number has an even exponent on every prime factor.', 'The exponents in 2⁵ × 3¹ are 5 and 1, both odd.'), 'Check the exponents, not whether a prime base happens to be even.', undefined, ['96 = 2⁵ × 3¹', 'What must be true of every exponent in a square number?'])
...
practice(listing, 'Find the HCF and LCM of 15 and 20.', 'N7.2 Q3', select(['HCF = 5 and LCM = 60', 'HCF = 15 and LCM = 20', 'HCF = 1 and LCM = 35'], 0), explain('HCF = 5 and LCM = 60', 'The greatest common factor is 5.', 'The first common positive multiple is 60.'), 'Use factor lists for the HCF and multiple lists for the LCM.', methodWorking(listingWorking(15, 20)))
practice(listing, 'List the first 5 multiples of 14.', 'N7.2 Q4a', select(['14, 28, 42, 56, 70', '1, 2, 7, 14, 28', '14, 24, 34, 44, 54'], 0), explain('14, 28, 42, 56, 70', 'Multiply 14 by 1, 2, 3, 4 and 5.', 'This gives 14, 28, 42, 56 and 70.'), 'Positive multiples are 14 × 1, 14 × 2, and so on.', methodWorking(multiplesWorking(14, 5)))
...
practice(listing, 'Explain why the HCF of two numbers can never be bigger than the smaller number.', 'N7.2 Q5b', select([
...
practice(venn, 'Write 40 as a product of its prime factors.', 'N7.3 Q2', select(['2³ × 5', '4 × 10', '2 × 20'], 0), explain('40 = 2³ × 5', 'A factor tree ends in 2, 2, 2 and 5.', 'Group the three 2s as 2³.'), 'Split until every end number is prime.', methodWorking(factorTreeWorking(40)))
practice(venn, 'Given 28 = 2² × 7 and 42 = 2 × 3 × 7, use a Venn diagram to find the HCF and LCM.', 'N7.3 Q3', select(['HCF = 14 and LCM = 84', 'HCF = 2 and LCM = 42', 'HCF = 28 and LCM = 42'], 0), explain('HCF = 14 and LCM = 84', 'The shared factors are 2 and 7, so HCF = 14.', 'Every region gives 2 × 2 × 3 × 7 = 84 for the LCM.'), 'Put one matching 2 and the 7 in the intersection.', methodWorking(vennWorking(28, 42)))
practice(venn, 'Write 90 as a product of its prime factors.', 'N7.3 Q4a', select(['2 × 3² × 5', '9 × 10', '2 × 45'], 0), explain('90 = 2 × 3² × 5', 'The prime ends are 2, 3, 3 and 5.', 'Group the repeated 3s as 3².'), 'Continue splitting 45 and 15 until every end is prime.', methodWorking(factorTreeWorking(90)))
...
practice(venn, 'A student claims HCF × LCM equals the product of the two numbers. Show whether this is true for p and q.', 'N7.3 Q5c', select([
...
], 0), explain('The products are equal for p and q.', 'HCF × LCM = 60 × 5,400 = 324,000.', 'p × q = 600 × 540 = 324,000, so the two sides match.'), 'Calculate both products separately and compare them.', undefined, ['p = 600 and q = 540', 'HCF = 60 and LCM = 5,400'])
