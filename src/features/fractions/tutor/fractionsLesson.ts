...
practice(simplifying, 'Sam says the simplest form of 36/48 is 6/8. Explain why Sam is wrong and choose the fully simplified fraction.', 'N8.1 Q4b', select([
...
], 0), 'Sam is wrong; the simplest form is 3/4.', 'Check whether 6 and 8 still have a common factor greater than 1.', undefined, ['Sam proposes 36/48 = 6/8', 'Is 6/8 fully simplified?'])
...
practice(simplifying, 'Jake says 51/85 cannot be simplified because 51 and 85 share no common factor. Show that Jake is wrong and choose the simplest form.', 'N8.1 Q5c', select([
...
], 0), '51/85 = 3/5.', 'Write 51 and 85 as products and look for a shared factor.', undefined, ['51 = 3 × 17', '85 = 5 × 17'])
...
practice(converting, 'Ravi says 7 2/5 = 47/5 because he adds 7 + 5 before adding 2. Explain his mistake and choose the correct improper fraction.', 'N8.2 Q5c', select([
...
], 0), '7 2/5 = 37/5.', 'A whole contains five fifths, so seven wholes contain 7 × 5 fifths.', undefined, ['7 wholes contain 35 fifths', 'Add the remaining 2 fifths'])
...
practice(adding, 'Tom adds 1/4 + 1/4 and gets 2/8 by adding both numerators and denominators. Explain why Tom is wrong and choose the correct answer.', 'N8.3 Q5c', select([
...
], 0), '1/4 + 1/4 = 1/2.', 'Adding counts equal-sized parts; it does not change the size of each part.', undefined, ['Two quarters are being counted', 'Keep the denominator 4'])
...
practice(subtracting, 'Maya subtracts 8/9 - 2/9 and writes 6/0 because she subtracts the denominators. Explain her mistake and choose the correct answer.', 'N8.4 Q5c', select([
...
], 0), '8/9 - 2/9 = 2/3.', 'The denominator names the size of the parts and stays 9.', undefined, ['Subtract two ninths from eight ninths', 'Six ninths remain'])
...
practice(multiplying, 'Ben says multiplying two fractions below 1 always gives an answer bigger than both fractions. Use 1/2 × 1/3 to decide whether Ben is correct.', 'N8.5 Q5c', select([
...
], 0), 'Ben is wrong; the product is 1/6.', 'Think of taking one third of one half.', undefined, ['1/2 × 1/3 = 1/6', 'Compare 1/6 with both factors'])
...
practice(dividing, 'Aisha says dividing by a fraction always makes a number bigger. Use 3/4 ÷ 3/2 to decide whether she is correct.', 'N8.6 Q5c', select([
...
], 0), 'Aisha is wrong; the result is 1/2.', 'The divisor 3/2 is greater than 1, so compare the result with 3/4.', undefined, ['3/4 × 2/3 = 1/2', '1/2 is smaller than 3/4'])
...
practice(mixedCalculations, 'Noah multiplies the whole-number parts and fractional parts of 2 1/2 × 1 1/3 separately, then adds them. Explain why this is wrong and choose the correct answer.', 'N8.7 Q5c', select([
...
], 0), 'The correct product is 3 1/3.', 'A mixed number is one value; convert the complete value before multiplying.', undefined, ['2 1/2 = 5/2', '1 1/3 = 4/3'])
...
practice(amounts, 'Priya says that to find 3/4 of an amount you must divide by 4 first and can never multiply by 3 first. Use 3/4 of £48 to decide whether she is correct.', 'N8.8 Q5c', select([
...
], 0), '£36 either way.', 'Calculate both orders and compare the results.', undefined, ['£48 ÷ 4 × 3', '£48 × 3 ÷ 4'])
