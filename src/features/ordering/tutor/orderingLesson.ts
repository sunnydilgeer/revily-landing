import { chooser, select, working } from '../../written-methods/model'
...
practice(decimals, 'Order 1.85 m, 1.58 m, 1.5 m, 1.08 m and 1.8 m from largest to smallest.', 'N11.1 Q3', choose([
  '1.85 m, 1.8 m, 1.58 m, 1.5 m, 1.08 m',
  '1.8 m, 1.85 m, 1.5 m, 1.58 m, 1.08 m',
  '1.08 m, 1.5 m, 1.58 m, 1.8 m, 1.85 m',
]), '1.85 m, 1.8 m, 1.58 m, 1.5 m, 1.08 m', 'Write 1.8 as 1.80 and 1.5 as 1.50.', {
...
practice(decimals, 'Order the race times 28.6 s, 28.06 s, 28.66 s and 28.16 s from fastest to slowest.', 'N11.1 Q4a', choose([
  '28.06 s, 28.16 s, 28.6 s, 28.66 s',
  '28.66 s, 28.6 s, 28.16 s, 28.06 s',
  '28.06 s, 28.16 s, 28.66 s, 28.6 s',
]), '28.06 s, 28.16 s, 28.6 s, 28.66 s', 'Fastest means the smallest time. Write 28.6 as 28.60.', {
...
practice(decimals, 'Ravi says 28.06 s is slower than 28.6 s because it has more digits. Is Ravi correct?', 'N11.1 Q4b', choose([
...
]), 'No - 28.06 s is the smaller time.', 'Compare place values, not the number of written digits.', {
...
practice(decimals, 'Order 1.25 L, 1.205 L, 1.3 L and 1.052 L from smallest to largest.', 'N11.1 Q5a', choose([
  '1.052 L, 1.205 L, 1.25 L, 1.3 L',
  '1.052 L, 1.25 L, 1.205 L, 1.3 L',
  '1.3 L, 1.25 L, 1.205 L, 1.052 L',
]), '1.052 L, 1.205 L, 1.25 L, 1.3 L', 'Give every value three decimal places.', {
...
practice(decimals, 'Sam says 1.205 is bigger than 1.25 because 205 is bigger than 25. Is Sam correct?', 'N11.1 Q5c', choose([
...
]), 'No - 1.25 is greater than 1.205.', 'Compare tenths, hundredths and thousandths in aligned columns.', {
...
practice(largeNumbers, 'Order 4316, 4361, 4136, 4613 and 4163 from largest to smallest.', 'N11.2 Q3', choose([
  '4613, 4361, 4316, 4163, 4136',
  '4613, 4316, 4361, 4136, 4163',
  '4136, 4163, 4316, 4361, 4613',
]), '4613, 4361, 4316, 4163, 4136', 'Compare hundreds, then use tens to break each tie.', {
...
practice(largeNumbers, 'Order 25 480, 25 084, 2548 and 25 840 from smallest to largest.', 'N11.2 Q4a', choose([
  '2548, 25 084, 25 480, 25 840',
  '25 084, 2548, 25 480, 25 840',
  '2548, 25 840, 25 480, 25 084',
]), '2548, 25 084, 25 480, 25 840', 'Start by counting digits.', {
...
practice(largeNumbers, 'Explain why 2548 is smaller than 25 084.', 'N11.2 Q4b', choose([
...
]), '2548 has fewer digits, so it is smaller.', 'Count the digits in each positive whole number.', {
...
practice(largeNumbers, 'Order £18 605, £18 065, £19 002, £9990 and £18 650 from largest to smallest.', 'N11.2 Q5a', choose([
  '£19 002, £18 650, £18 605, £18 065, £9990',
  '£9990, £19 002, £18 650, £18 605, £18 065',
  '£19 002, £18 605, £18 650, £18 065, £9990',
]), '£19 002, £18 650, £18 605, £18 065, £9990', '£9990 is the only 4-digit amount. Compare the 5-digit amounts from the left.', {
...
practice(largeNumbers, 'Leah says £9990 is the biggest amount because 9 is the biggest first digit. Is Leah correct?', 'N11.2 Q5c', choose([
...
]), 'No - the 5-digit amounts are bigger than £9990.', 'For positive whole numbers, compare digit counts before first digits.', {
...
practice(negatives, 'Order −3.5 °C, 2.4 °C, −3.05 °C, −4.2 °C and 0 °C from coldest to warmest.', 'N11.3 Q3', choose([
  '−4.2 °C, −3.5 °C, −3.05 °C, 0 °C, 2.4 °C',
  '−3.05 °C, −3.5 °C, −4.2 °C, 0 °C, 2.4 °C',
  '2.4 °C, 0 °C, −3.05 °C, −3.5 °C, −4.2 °C',
]), '−4.2 °C, −3.5 °C, −3.05 °C, 0 °C, 2.4 °C', 'Order the negatives by their distance below zero, then place 0 and the positive value.', {
...
practice(negatives, 'Order −86 m, 120 m, −8.6 m, −68 m and 12 m from lowest to highest.', 'N11.3 Q4a', choose([
  '−86 m, −68 m, −8.6 m, 12 m, 120 m',
  '−8.6 m, −68 m, −86 m, 12 m, 120 m',
  '120 m, 12 m, −8.6 m, −68 m, −86 m',
]), '−86 m, −68 m, −8.6 m, 12 m, 120 m', 'Place negatives first; among them, the greatest magnitude is lowest.', {
...
practice(negatives, 'Order −£60, £25, −£140, −£15 and £0 from largest to smallest.', 'N11.3 Q5a', choose([
  '£25, £0, −£15, −£60, −£140',
  '£25, £0, −£140, −£60, −£15',
  '−£140, −£60, −£15, £0, £25',
]), '£25, £0, −£15, −£60, −£140', 'Positive balances come first; among debts, owing less is the greater balance.', {
...
practice(negatives, 'Ravi says −£140 is greater than −£60 because 140 is greater than 60. Is Ravi correct?', 'N11.3 Q5c', choose([
...
]), 'No - −£140 is less than −£60.', 'On a number line, −140 lies farther left than −60.', {
...
practice(mixedForms, 'Order 7/10, 0.72, 68% and 3/4 from largest to smallest.', 'N11.4 Q3', choose([
  '3/4, 0.72, 7/10, 68%',
  '0.72, 3/4, 7/10, 68%',
  '68%, 7/10, 0.72, 3/4',
]), '3/4, 0.72, 7/10, 68%', 'Convert every value to a decimal before ordering.', {
...
practice(mixedForms, 'Mia has 0.35, Leo has 36%, Sam has 3/8 and Zara has 2/5 of a pizza. Order them from smallest to largest.', 'N11.4 Q4a', choose([
  'Mia 0.35, Leo 36%, Sam 3/8, Zara 2/5',
  'Mia 0.35, Sam 3/8, Leo 36%, Zara 2/5',
  'Zara 2/5, Sam 3/8, Leo 36%, Mia 0.35',
]), 'Mia 0.35, Leo 36%, Sam 3/8, Zara 2/5', 'Convert all four amounts to decimals and align three places.', {
...
practice(mixedForms, 'Order Ola 0.7, Kim 0.705, Lee 71%, Jo 18/25 and Max 29/40 from smallest to largest.', 'N11.4 Q5a', choose([
...
]), 'Ola 0.7, Kim 0.705, Lee 71%, Jo 18/25, Max 29/40', 'Convert every mark to a decimal with three places.', {
...
practice(mixedForms, 'Ali says 18/25 is less than 71% because 18 is less than 71. Is Ali correct?', 'N11.4 Q5c', choose([
...
]), 'No - 18/25 = 72%, which is greater than 71%.', 'Compare values in the same form.', {
