...
export const expandedTeaching: ScienceState[] = [
  ...
  choice('B1-28', 'Which statement about bacterial genetic material is correct?', [['loop', 'Its main DNA forms a loop in the cytoplasm, outside a nucleus.'], ['none', 'It has no DNA because it has no nucleus.'], ['nucleus', 'Its DNA is enclosed in a nucleus.']], 'loop', 'No nucleus does not mean no genetic material.', ['Bacteria contain genetic material.', 'Their main DNA forms a single loop in the cytoplasm. Some bacteria also have small extra DNA rings called plasmids.']),
  ...
  { ...base, id: 'B1-30', kind: 'teaching', phase: 'guided', title: 'Estimate an area using a simple shape', body: 'Estimate this mitochondrion’s area by treating its outline as a rectangle 8 µm long and 2 µm wide.', steps: ['Use a rectangle as a simple shape that is close to the mitochondrion’s outline.', 'Multiply length by width: 8 × 2 = 16.', 'Estimated area ≈ 16 µm². The ≈ symbol means approximately equal. The real outline is curved, so this is not an exact area.'] },
  choice('B1-31', 'Why is the rectangular area only an estimate?', [['curve', 'The curved structure does not exactly fill the rectangle.'], ['exact', 'Every mitochondrion is an exact rectangle.'], ['length', 'Area uses only the length.']], 'curve', 'Compare the simple shape with the curved outline.', ['The mitochondrion has a curved outline, but the calculation treats it as a rectangle.', 'Because those shapes do not match exactly, the calculated area is only an estimate.']),
]
...
export const expandedIndependent: ScienceState[] = [
  ...
  choice('B1-33', 'What does a permanent vacuole contain?', [['sap', 'Cell sap'], ['dna', 'The main bacterial DNA loop'], ['cellulose', 'Cellulose']], 'sap', 'Recall what fills this plant-cell compartment.', ['The permanent vacuole contains cell sap, a watery solution of dissolved substances.'], true),
