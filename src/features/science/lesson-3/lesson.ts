...
export const lesson3: ScienceLesson = {
  id: 'B-CELL-003', contentVersion: '0.1.0', qualification: 'AQA-8464F', strand: 'biology',
  ...
  states: [
    q('B3-01', 'Why should an onion specimen be very thin?', [['light', 'So light can pass through and cells can be distinguished'], ['grow', 'So the microscope makes the cells grow'], ['colour', 'So no stain can reach the cells']], 'light', 'A light microscope needs light to pass through the specimen.', ['Thin tissue lets light pass through.', 'A thick or overlapping sample obscures individual cells.'], 'understanding'),
    teach('B3-02', 'Equipment and safety'),
    q('B3-03', 'A coverslip breaks on the bench. What should you do?', [['report', 'Tell the teacher and keep clear of the broken glass'], ['hand', 'Pick up the tiny shards with your fingers'], ['hide', 'Push it onto the floor']], 'report', 'Think about cuts and safe laboratory procedures.', ['Broken glass can cut skin.', 'Report it and follow the teacher’s safe clean-up procedure; do not collect shards by hand.']),
    teach('B3-04', 'Prepare an onion-cell slide'),
    q('B3-05', 'Why add iodine stain to the onion specimen?', [['contrast', 'To make some cell structures easier to distinguish'], ['bigger', 'To increase the microscope’s magnification'], ['all', 'To guarantee that every sub-cellular structure is visible']], 'contrast', 'Think about contrast, not enlargement.', ['A stain increases contrast between some structures.', 'It does not change lens magnification or reveal everything.'], 'understanding'),
    q('B3-06', 'Why lower the coverslip slowly at an angle?', [['air', 'To reduce trapped air bubbles'], ['grow', 'To stretch the cells until they grow'], ['lens', 'To change the objective magnification']], 'air', 'Consider how air escapes as the cover meets the liquid.', ['Touching one edge to the liquid and lowering gently lets air escape.', 'Trapped bubbles may obscure the specimen.']),
    ...
    q('B3-09', 'Why begin with the lowest-power objective?', [['wide', 'Its wider field of view makes the specimen easier to locate'], ['largest', 'It always gives the largest image'], ['stain', 'It adds stain to the sample']], 'wide', 'Think about finding the specimen before enlarging it.', ['Low power shows a larger area.', 'Find and centre cells before switching to higher magnification.']),
    q('B3-10', 'When bringing the objective close to the slide at low power, where should you look?', [['side', 'From the side, watching the gap so the lens does not touch the slide'], ['eye', 'Only through the eyepiece while moving towards the glass'], ['away', 'Away from the microscope']], 'side', 'You need to see the gap directly.', ['Watch from the side when approaching the slide.', 'Never allow the objective to contact the glass.']),
    q('B3-11', 'After switching to a higher-power objective, which control should you use to sharpen the view?', [['fine', 'Fine adjustment, using small movements'], ['coarse', 'Large coarse-adjustment movements towards the slide'], ['clip', 'The slide clip as a focusing control']], 'fine', 'At high power the lens may be very close to the glass.', ['Fine adjustment makes small focusing changes.', 'Large coarse movements at high power risk contact with the slide.']),
    ...
    { ...base, id: 'B3-20', kind: 'teaching', phase: 'guided', title: 'Drawing magnification: a worked example', body: 'A drawn cell is 24 mm long. Its calibrated real length is 0.3 mm. Calculate the drawing magnification.', steps: ['Both lengths are in mm, so the units match.', 'Drawing magnification = drawing length ÷ real length = 24 ÷ 0.3.', 'Drawing magnification = ×80. It is not automatically the microscope magnification.'] },
    ...
    q('B3-22', 'A student cannot easily distinguish the nucleus from its surroundings. Why might a suitable stain help?', [['contrast', 'It increases contrast so some structures are easier to distinguish'], ['growth', 'It makes the real nucleus larger'], ['lens', 'It increases the lens magnification']], 'contrast', 'Recall the purpose of staining.', ['A suitable stain makes some structures contrast with their surroundings.', 'It does not enlarge the specimen or alter the lenses.'], 'recall', true),
    q('B3-23', 'Several onion layers overlap on a slide. Which change would improve the specimen?', [['thin', 'Use a thin epidermal layer and spread it flat'], ['thick', 'Add more thick onion pieces'], ['dark', 'Turn off the light completely']], 'thin', 'Think about light passing through and separate cells.', ['A thin flat layer transmits light and reduces overlapping cells.'], 'practicalReasoning', true),
    ...
    q('B3-29', 'A calibrated field is 1.5 mm wide. Five similar cells fit end to end across the full diameter. Estimate one cell’s length in µm.', [['300', '300 µm'], ['0.3', '0.3 µm'], ['7500', '7500 µm']], '300', 'Divide the field width by the number of cells, then convert mm to µm.', ['Estimated length = 1.5 ÷ 5 = 0.3 mm.', '0.3 × 1000 = 300 µm. This is an estimate based on similar cell lengths.'], 'dataInterpretation', true),
    { ...base, id: 'B3-30', kind: 'written', phase: 'transfer', title: 'Describe how to prepare a stained onion-cell slide and obtain a clear image safely.', contextId: 'practical-written-transfer', dimensions: ['explanation'], evidenceRole: 'independent', marking: 'teacherOnly',
      hint: 'Describe slide preparation, then the order of locating and focusing the specimen.', placeholder: 'First prepare the slide by… . Then use the microscope by… .', instruction: 'Give a short, ordered method with safe focusing.',
      explanation: { steps: ['Prepare thin, flat tissue in liquid and add stain.', 'Lower the coverslip gently at an angle.', 'Find the specimen at low power.', 'Focus safely, then sharpen with fine adjustment.'], answer: 'Place thin onion epidermis flat in a drop of water on a clean slide, add iodine as directed and gently lower a coverslip at an angle. Secure the slide on the stage and start with the lowest objective. Watch from the side when bringing the lens close without touching the glass; increase the gap while viewing to find rough focus, then use fine adjustment for a sharp image.' },
