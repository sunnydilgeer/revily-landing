...
export const expandedTeaching: ScienceState[] = [
  ...
  choice('B1-25', 'Which plant structure strengthens and supports the cell?', [['wall', 'Cell wall'], ['membrane', 'Cell membrane'], ['ribosomes', 'Ribosomes']], 'wall', 'Which layer supports the cell? Which controls entry and exit?', ['The cellulose cell wall strengthens the plant cell.', 'The cell membrane controls movement of substances, a different function.']),
  choice('B1-26', 'A root cell has no chloroplasts. Must it be an animal cell?', [['no', 'No. Some plant cells do not have chloroplasts.'], ['yes', 'Yes. Every plant cell has chloroplasts.'], ['shape', 'Only its outline can tell us.']], 'no', 'Some plant cells lack chloroplasts. Think about root cells.', ['Root cells are plant cells even when they lack chloroplasts.', 'Do not classify a cell solely by the absence of chloroplasts or by its shape.']),
  teach('B1-41', 'Compare animal and plant cells', 30),
  teach('B1-27', 'Bacterial cells: meet the cell', 65),
  choice('B1-28', 'Which statement about bacterial genetic material is correct?', [['loop', 'Its main DNA forms a loop in the cytoplasm, outside a nucleus.'], ['none', 'It has no DNA because it has no nucleus.'], ['nucleus', 'Its DNA is enclosed in a nucleus.']], 'loop', 'No nucleus does not mean no genetic material.', ['Bacteria contain genetic material.', 'Their main DNA is a loop in the cytoplasm. Some also have plasmids: small extra DNA rings.']),
  ...
  { ...base, id: 'B1-30', kind: 'teaching', phase: 'guided', title: 'Estimate an area using a simple shape', body: 'Use a rectangle to estimate this mitochondrion’s area. Length: 8 µm. Width: 2 µm.', steps: ['Use a rectangle close to the curved outline.', 'Multiply length by width: 8 × 2 = 16.', 'Estimated area ≈ 16 µm². The symbol ≈ means about equal. The curved shape does not exactly fill the rectangle.'] },
  choice('B1-31', 'Why is the rectangular area only an estimate?', [['curve', 'The curved structure does not exactly fill the rectangle.'], ['exact', 'Every mitochondrion is an exact rectangle.'], ['length', 'Area uses only the length.']], 'curve', 'Compare the simple shape with the curved outline.', ['The mitochondrion has a curved outline, but the calculation treats it as a rectangle.', 'The shapes do not match exactly, so the answer is an estimate.']),
]
...
export const expandedIndependent: ScienceState[] = [
  ...
  choice('B1-33', 'What does a permanent vacuole contain?', [['sap', 'Cell sap'], ['dna', 'The main bacterial DNA loop'], ['cellulose', 'Cellulose']], 'sap', 'Recall what fills this plant-cell compartment.', ['The permanent vacuole holds cell sap: water with dissolved substances.'], true),
  ...
  choice('B1-38', 'An animal cell’s diameter is 40 µm. A bacterium’s is 2 µm. How many times larger is the animal cell’s diameter?', [['20', '20 times'], ['38', '38 times'], ['80', '80 times']], '20', 'The units match. Divide the larger diameter by the smaller one.', ['40 ÷ 2 = 20.', 'This compares diameters, not areas or volumes.'], true, true),
  ...
  choice('B1-40', 'Which standard-form expression equals 0.004 mm?', [['correct', '4 × 10⁻³ mm'], ['positive', '4 × 10³ mm'], ['wrong', '4 × 10⁻⁴ mm']], 'correct', 'Here, 10⁻³ means 0.001. Check which expression gives the stated length.', ['10⁻³ = 0.001.', '4 × 0.001 = 0.004 mm.'], true, true),
]
