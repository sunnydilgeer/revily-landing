...
export const digestionFrames: Record<string, TeachingFrame[]> = {
  'B9-02': [
    f('Why digestion is needed', 'Large food molecules must be broken into smaller soluble molecules.', 'large and insoluble → small and soluble', 'Starch, proteins and lipids are too large to pass through the wall of the digestive system. Digestive enzymes break them into smaller molecules that can dissolve and be absorbed into the bloodstream.', 'digestion-size'),
  ...
  'B9-04': [
    f('Carbohydrases', 'Carbohydrases break carbohydrates into simple sugars.', 'starch → sugar', 'Amylase is a carbohydrase. It breaks starch into sugars. Glucose is one sugar that cells can use in respiration.', 'digestion-amylase'),
    f('Proteases', 'Proteases break proteins into amino acids.', 'protein → amino acids', 'Amino acids are small soluble products of protein digestion. The body can use absorbed amino acids to build new proteins.', 'digestion-protease'),
    f('Lipases', 'Lipases break lipids into glycerol and fatty acids.', 'lipid → two products', 'Lipids are fats and oils. Lipase breaks them into glycerol and fatty acids. The absorbed products can be used to build new lipids.', 'digestion-lipase'),
  ],
  'B9-07': [
  ...
  'B9-10': [
    ...
    f('Bile neutralises acid', 'Bile is alkaline, so it raises the pH of acidic stomach contents.', 'acid + alkali → suitable pH', 'Food arriving from the stomach contains hydrochloric acid. Bile helps neutralise this acid and creates alkaline conditions in the small intestine, where its digestive enzymes work effectively.', 'bile-neutralise'),
  ...
  'B9-20': [
    f('Read each result separately', 'A sample can contain more than one food group.', 'test → observation → conclusion', 'Do not decide from the food’s appearance. Match each observed colour or layer to its test. For example, blue-black iodine shows starch, while purple Biuret shows protein.', 'food-results'),
