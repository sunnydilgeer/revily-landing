...
export function recommendedNext(profile: Profile, retrievalDue: boolean, lesson?: ScienceLesson) {
  ...
  const easierOnlyNextIds: Record<string, string> = { ...nextLessonIds,
    ...
    'B-ORG-018': 'B-INF-019', 'B-INF-019': 'B-INF-020', 'B-INF-020': 'B-INF-021', 'B-INF-021': 'B-INF-022', 'B-INF-022': 'B-INF-023', 'B-INF-023': 'B-INF-024', 'B-INF-024': 'B-INF-025', 'B-INF-025': 'B-BIO-026' }
