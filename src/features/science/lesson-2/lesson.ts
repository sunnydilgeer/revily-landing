...
export const lesson2: ScienceLesson = {
  ...
  states: [
    ...
    teach('B2-06', 'Resolution distinguishes detail'),
    q('B2-07', 'Two close features appear as one merged patch. What is limiting the detail?', [['res', 'The resolving power of the view'], ['growth', 'The cell growing too quickly'], ['colour', 'The colour chosen for the diagram']], 'res', 'Which idea concerns distinguishing two close points?', ['Resolution determines whether close features can be distinguished as separate.']),
    ...
    q('B2-11', 'How did developments in electron microscopy help scientists understand cells?', [['detail', 'They could investigate smaller sub-cellular structures in finer detail'], ['created', 'They created new structures inside cells'], ['all', 'They proved every structure is visible with any microscope']], 'detail', 'Think about the information improved tools reveal.', ['Higher magnification and resolution enabled more detailed investigation.', 'Newly distinguished structures improved understanding; the instrument did not create them.']),
    teach('B2-12', 'Calculate magnification'),
    worked('B2-13', 'Magnification: a worked example', 'An image is 12 mm wide. The real cell is 0.03 mm wide. Find the magnification.', ['Both sizes are in mm, so the units match.', 'Magnification = image size ÷ real size = 12 ÷ 0.03.', 'Magnification = ×400. It has no length unit.']),
    ...
    worked('B2-16', 'Different units: a worked example', 'An image is 18 mm wide. The real cell is 30 µm wide. Find the magnification.', ['Match the units: 30 µm ÷ 1000 = 0.03 mm.', 'Magnification = 18 mm ÷ 0.03 mm.', 'Magnification = ×600. Alternatively, 18 000 µm ÷ 30 µm gives the same result.']),
    ...
    worked('B2-19', 'Real size: a worked example', 'A cell image is 15 mm wide at ×500 magnification. Find the real width in µm.', ['Real size = image size ÷ magnification.', '15 ÷ 500 = 0.03 mm.', 'Convert to µm: 0.03 × 1000 = 30 µm.']),
    teach('B2-20', 'Find the image size'),
    worked('B2-21', 'Image size: a worked example', 'A real cell is 0.04 mm wide. Find its image width at ×250 magnification.', ['Image size = real size × magnification.', '0.04 × 250 = 10.', 'Image width = 10 mm. The image is larger than the specimen.']),
    ...
    { ...base, id: 'B2-34', kind: 'written', phase: 'transfer', title: 'Explain how greater resolving power in electron microscopes helped scientists understand cell structures.',
      contextId: 'microscopy-written-transfer', dimensions: ['explanation'], evidenceRole: 'independent', marking: 'teacherOnly', hint: 'Link what can be distinguished to what scientists can learn.',
      placeholder: 'Greater resolving power allows…, which helps scientists… .', instruction: 'Link the improved view to improved understanding.',
      explanation: { steps: ['Explain the improvement in distinguishing close structures.', 'Link the additional detail to understanding sub-cellular structures.'], answer: 'Greater resolving power allows smaller, closely spaced structures to be distinguished. Scientists can study more sub-cellular detail and improve their understanding of cell structure.' },
