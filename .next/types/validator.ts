...
// Validate ../../app/api/grade-response/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/grade-response">> = Specific
  const handler = {} as typeof import("../../app/api/grade-response/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
